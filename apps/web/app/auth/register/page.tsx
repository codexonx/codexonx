...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!isApiConfigured) {
        setError('Kayıt servisi yapılandırılmadı. Lütfen NEXT_PUBLIC_API_URL değerini ekleyin.');
        return;
      }
      ...
      if (result) {
        ...
        setError('Kayıt yapılamadı. Lütfen bilgilerinizi kontrol edin veya daha sonra deneyin.');
      }
    } catch (err) {
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {!isApiConfigured ? (
                <Alert className="mb-4 border-primary/50">
                  ...
                  <AlertDescription>
                    Demo modundasınız. Kayıt işlemleri için NEXT_PUBLIC_API_URL çevre değişkenini
                    yapılandırın.
                  </AlertDescription>
                </Alert>
              ) : null}
