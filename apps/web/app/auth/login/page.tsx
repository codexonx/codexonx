...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!isApiConfigured) {
        setError('Giriş servisi yapılandırılmadı. Lütfen NEXT_PUBLIC_API_URL değerini ekleyin.');
        return;
      }
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {!isApiConfigured ? (
                <Alert className="mb-4 border-primary/50">
                  ...
                  <AlertDescription>
                    Demo modundasınız. Giriş yapabilmek için NEXT_PUBLIC_API_URL çevre değişkenini
                    yapılandırın.
                  </AlertDescription>
                </Alert>
              ) : null}
