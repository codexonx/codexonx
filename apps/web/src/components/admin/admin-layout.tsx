...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className={`hidden md:block transition-all duration-300 ease-in-out ${isNavCollapsed ? 'w-16' : 'w-64'}`}>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="h-16 border-b flex items-center justify-between px-4 bg-background">
          <div className="flex items-center">
            {/* Mobile menu button */}
            <Button variant="ghost" size="icon" className="md:hidden mr-2" onClick={() => setIsMobileNavOpen(true)}>
