...
TabsList.displayName = TabsPrimitiveList.displayName ?? 'TabsList';
...
TabsTrigger.displayName = TabsPrimitiveTrigger.displayName ?? 'TabsTrigger';
...
TabsContent.displayName = TabsPrimitiveContent.displayName ?? 'TabsContent';
