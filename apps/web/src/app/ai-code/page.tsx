...
import { ArrowRight, Code, Sparkles, Github, FileCode, Braces, LucideTerminalSquare } from "lucide-react";
      ...
      <main className="container mx-auto px-4 py-16 flex flex-col items-center">
        ...
        >
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Yapay zeka destekli kod asistanı ile projelerinizi daha hızlı ve verimli bir şekilde geliştirin.
            Sorularınızı cevaplayalım, kodlarınızı iyileştirelim, hatalarınızı düzeltelim.
          </motion.p>
        ...
        >
          ...
          <div className="p-4 text-sm font-mono text-gray-300">
            ...
            <div className="text-blue-400">function <span className="text-yellow-400">createSmartComponent</span>{'('}<span className="text-green-400">config</span>{')'} {'{'}</div>
            <div className="pl-4 text-gray-300">// AI tarafından tamamlanacak kod</div>
            <div className="pl-4 text-gray-300">const {'{'} type, props {'}'} = config;</div>
            <div className="pl-4 text-gray-300">{''}</div>
            <div className="pl-4 text-blue-400">if <span className="text-gray-300">(</span><span className="text-green-400">type</span> === <span className="text-orange-400">'react'</span><span className="text-gray-300">)</span> {'{'}</div>
            <div className="pl-8 text-gray-300">// React bileşeni oluştur</div>
            <div className="pl-8 text-yellow-400">return <span className="text-blue-400">new</span> ReactComponent<span className="text-gray-300">(props);</span></div>
            <div className="pl-4 text-blue-400">{'}'} <span className="text-blue-400">else if</span> <span className="text-gray-300">(</span><span className="text-green-400">type</span> === <span className="text-orange-400">'vue'</span><span className="text-gray-300">)</span> {'{'}</div>
            <div className="pl-8 text-blue-400">// <span className="text-gray-500">AI buradan devam edecek...</span></div>
            <div className="pl-8 text-gray-300"><span className="bg-blue-500/20 px-1">return new VueComponent(props);</span></div>
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-4">Projelerinizi hızlandırmaya hazır mısınız?</h2>
          <p className="text-lg text-blue-100 mb-6">Yapay zeka destekli kod asistanımızla geliştirme sürecinizi dönüştürün.</p>
          <Button 
            size="lg" 
