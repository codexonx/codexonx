...
const projects = [
  {
    ...
    description:
      'React ve TensorFlow.js kullanarak oluşturulmuş AI destekli bir metin editörü. Metin düzenleme ve öneriler için yapay zeka kullanıyor.',
    author: {
      name: 'Ahmet Yılmaz',
  ...
  },
  {
    ...
    description:
      "Next.js, Socket.io ve D3.js ile geliştirilmiş gerçek zamanlı veri izleme dashboard'u. Anında veri güncellemeleri ve interaktif grafikler içerir.",
    author: {
      name: 'Zeynep Kaya',
      username: 'zeynepk',
  ...
  },
  {
    ...
    description:
      'Ethereum blockchain üzerinde çalışan güvenli bir oylama sistemi. Akıllı kontratlar ve web arayüzü içerir.',
    author: {
      name: 'Emre Demir',
      username: 'emredemir',
  ...
  },
  {
    ...
    description:
      'Türkçe metinler için özelleştirilmiş, kapsamlı bir doğal dil işleme kütüphanesi. Duygu analizi, metin sınıflandırma ve özetleme özellikleri içerir.',
    author: {
      name: 'Deniz Yıldız',
  ...
  },
  {
    ...
    description:
      'Docker ve Kubernetes kullanarak ölçeklenebilir mikro servis mimarisi örneği. API Gateway, hizmet keşfi ve izleme içerir.',
    author: {
      name: 'Mehmet Özkan',
...
const discussions = [
  {
    ...
    description:
      "Next.js'in yeni App Router yapısı ile eski Pages Router arasındaki farkları ve hangisinin ne zaman kullanılması gerektiğini tartışalım.",
    author: {
      name: 'Can Aydın',
      username: 'canaydin',
  ...
  },
  {
    ...
    description:
      "TypeScript'te tip güvenliği sağlamanın, hataları azaltmanın ve daha sürdürülebilir kod yazmanın yollarını tartışalım.",
    author: {
      name: 'Ayşe Yılmaz',
      username: 'ayseyilmaz',
  ...
  },
  {
    ...
    description:
      'Yapay zekanın yazılım geliştirme üzerindeki etkileri ve gelecekte bizi bekleyen değişimler hakkında görüşleriniz neler?',
    author: {
      name: 'Burak Kaya',
      username: 'burakkaya',
          ...
          {filteredProjects.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mt-2">
                Arama kriterlerinize uygun proje bulunamadı. Lütfen başka terimlerle arayın.
              </p>
            </div>
          ) : (
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        <CardTitle className="text-xl hover:text-primary hover:underline">
                          <a href={`/dashboard/community/projects/${project.id}`}>
                            {project.title}
                          </a>
                        </CardTitle>
                      ...
                      <Button variant="ghost" size="icon" className="h-8 w-8">
                        <Star
                          className={`h-5 w-5 ${project.stars > 100 ? 'text-yellow-400 fill-yellow-400' : ''}`}
                        />
                      </Button>
                    </div>
                  </CardHeader>
        ...
        <TabsContent value="discussions" className="space-y-6">
          {filteredDiscussions.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mt-2">
                Arama kriterlerinize uygun tartışma bulunamadı. Lütfen başka terimlerle arayın.
              </p>
            </div>
          ) : (
            <div className="grid gap-6">
              {filteredDiscussions.map(discussion => (
                <Card key={discussion.id}>
                  <CardHeader>
                    <CardTitle className="text-xl hover:text-primary hover:underline">
                      <a href={`/dashboard/community/discussions/${discussion.id}`}>
                        {discussion.title}
                      </a>
                    </CardTitle>
                  </CardHeader>
                  ...
                  <CardFooter className="flex justify-between border-t pt-4">
                    <div className="flex items-center">
                      ...
                      <div className="ml-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Başlatıldı: {discussion.createdAt}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-4 text-muted-foreground text-sm">
            ...
            {[...projects, ...discussions]
              ...
              .map((person, index) => (
                <Card key={index}>
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      Aktif topluluk üyesi, {Math.floor(Math.random() * 20) + 1} proje ve{' '}
                      {Math.floor(Math.random() * 30) + 1} tartışmaya katkıda bulundu.
                    </p>
                  </CardContent>
